...
export default function TrackModal({ modalData }: { modalData: ModalProps }) {
  const { track, artists, preview_url, recommendations, image, closeHandler } =
    modalData;
      ...
      <div>
        ...
        <div className="flex w-fit py-4">
          {artists.map((artist, key) => (
            <div
              key={key}
              className="rounded-full overflow-hidden relative w-24 h-24 mx-1 cursor-pointer shadow-md hover:shadow-xl duration-75"
            >
              <Image
