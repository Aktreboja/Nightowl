...
export default function QueueCard({ track } : { track: Track }) {
    ...
    return (
    <div className="bg-white border border-[rgb(200,200,200)] flex items-center shadow-md rounded-md relative">
        <div className="absolute text-2xl  right-3 top-1/2 transform -translate-y-1/2 cursor-pointer">
            <IoMdCloseCircleOutline onClick = {() =>  dispatch(removeTrackFromQueue(track))}/>
        </div>
