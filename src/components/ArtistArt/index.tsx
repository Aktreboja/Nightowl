...
export default  function ArtistArt({ artist } : {artist: Artist}) {
    ...
    return (
        <div className="relative  rounded-full w-24 h-24 m-0 hover:shadow-lg duration-100 cursor-pointer  " onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} onClick = {() => dispatch(setSelected(artist))}>
